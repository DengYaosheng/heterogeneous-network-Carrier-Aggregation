...
W_num=[5,5,5,5,5];  % wifi STA num in different CCs
...
xlabel('CC序号'),ylabel('平均LTE-U用户吞吐量(Mbps)')  %设置x轴和y轴的名称
...
fx=bar(avgw);
set(gca,'XTickLabel',{'1','2','3','4','5'}) %设置x轴所代表大时间
xlabel('CC序号'),ylabel('平均WiFi用户吞吐量(Mbps)')  %设置x轴和y轴的名称
legend('U-CCS','RS','CS')  %区分一下蓝色和红色分别代表什么
ch = get(fx,'children');
set(fx(1), 'FaceColor',[1 0 0]);% Pink
set(fx(2), 'FaceColor',[0 1 0]); % Green
...
plot(L_min2,'-sb');
grid on
xlabel('LTE-U用户到达'),ylabel('最小LTE-U用户吞吐量(Mbps)')  %设置x轴和y轴的名称
legend('U-CCS','RS','CS')  %区分一下蓝色和红色分别代表什么
...
plot(W_min2,'-sb');
grid on
xlabel('LTE-U用户到达'),ylabel('最小WiFi用户吞吐量(Mbps)')  %设置x轴和y轴的名称
legend('U-CCS','RS','CS')  %区分一下蓝色和红色分别代表什么
x=get(gca,'xlim');
y=2;
...
plot(L_chs2,'-sb');
grid on
xlabel('LTE-U用户到达'),ylabel('新到达LTE-U用户吞吐量(Mbps)')  %设置x轴和y轴的名称
legend('U-CCS','RS','CS')  %区分一下蓝色和红色分别代表什么
